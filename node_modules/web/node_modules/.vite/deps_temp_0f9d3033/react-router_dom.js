...
} from "./chunk-HDIPN422.js";
import {
  __toESM,
  require_react
} from "./chunk-N5UK6PNW.js";
...
// ../../node_modules/react-router/dist/development/lib/dom-export/hydrated-router.js
...
function createHydratedRouter({ getContext, instrumentations }) {
  ...
  let router2 = createRouter({
    ...
    hydrationRouteProperties,
    instrumentations,
    dataStrategy: getTurboStreamSingleFetchDataStrategy(() => router2, ssrInfo.manifest, ssrInfo.routeModules, ssrInfo.context.ssr),
...
function HydratedRouter(props) {
  ...
  let [criticalCss, setCriticalCss] = React$12.useState(true ? ssrInfo?.context.criticalCss : void 0);
  React$12.useEffect(() => {
    if (true) setCriticalCss(void 0);
  }, []);
  React$12.useEffect(() => {
    if (criticalCss === void 0) document.querySelectorAll(`[${CRITICAL_CSS_DATA_ATTRIBUTE}]`).forEach((element) => element.remove());
  }, [criticalCss]);
  let [location2, setLocation] = React$12.useState(router.state.location);
  React$12.useLayoutEffect(() => {
  ...
  return React$12.createElement(React$12.Fragment, null, React$12.createElement(FrameworkContext.Provider, { value: {
  ...
  } }, React$12.createElement(RemixErrorBoundary, { location: location2 }, React$12.createElement(RouterProvider$1, {
    router,
    useTransitions: props.useTransitions,
    onError: props.onError
  }))), React$12.createElement(React$12.Fragment, null));
}

// ../../node_modules/react-router/dist/development/lib/rsc/browser.js
...
function createCallServer({ createFromReadableStream, createTemporaryReferenceSet, encodeReply, fetch: fetchImplementation = fetch }) {
  ...
  return async (id, args) => {
    ...
    React$13.startTransition(() => Promise.resolve(payloadPromise).then(async (payload) => {
...
function RSCHydratedRouter({ createFromReadableStream, fetch: fetchImplementation = fetch, payload, getContext }) {
  ...
  let { router: router2, routeModules } = React$13.useMemo(() => createRouterFromPayload({
    payload,
    fetchImplementation,
    getContext,
  ...
  let [{ routes, state }, setState] = React$13.useState(() => ({
    routes: cloneRoutes(router2.routes),
    state: router2.state
  }));
  React$13.useLayoutEffect(() => router2.subscribe((newState) => {
    if (diffRoutes(router2.routes, routes)) React$13.startTransition(() => {
      setState({
        routes: cloneRoutes(router2.routes),
        state: newState
      });
  ...
  const transitionEnabledRouter = React$13.useMemo(() => ({
    ...router2,
    state,
    routes
  }), [
  ...
  return React$13.createElement(RSCRouterContext.Provider, { value: true }, React$13.createElement(RSCRouterGlobalErrorBoundary, { location: state.location }, React$13.createElement(FrameworkContext.Provider, { value: frameworkContext }, React$13.createElement(RouterProvider, {
...
// ../../node_modules/react-router/dist/development/lib/rsc/html-stream/browser.js
...
export {
  HydratedRouter,
  RouterProvider$1 as RouterProvider,
